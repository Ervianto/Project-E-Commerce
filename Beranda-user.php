    ...
    <nav class="navbar nav2 navbar-expand-lg navbar-light">
      ...
      <div class="jumbotron p-5 mb-4">
        ...
        <div class="text container-fluid py-5">
          <h1 class="display-5 fw-bold">Selamat Datang di Online Shop Bonafide</h1>
          <p class="col-md-8 fs-5"><?php echo $_SESSION['email'] ?>&nbsp;sebagai <?php echo $_SESSION['level']?></p>
        </div>
      </div>
      <div class="col-md-6 mt-6">
        <img src="images\selamat.svg" class="dompetsapi d-block w-100" alt="...">
      </div>
        </div>
      </div>
        </div>
        <div class="carousel2 carousel-item">
          ...
          <div class="col-md-6 mt-6">
            <img src="images\dompetsapi.png" class="sandal d-block w-100" alt="...">
          </div>
            </div>
            </div>
          </div>
